...
func TestAccPackageDataSource_basic(t *testing.T) {
	dsn := "data.nebraska_package.test"
...
data "nebraska_package" "test" {
 version = nebraska_package.test.version
 arch    = nebraska_package.test.arch
}
`
